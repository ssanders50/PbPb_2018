...
config.General.requestName = 'PbPb2018_LM_SBNeg_z3_MB0'
config.Data.outLFNDirBase = '/store/user/ssanders/PbPb2018_LM_SBNeg_z3_MB0'
...
for i in range(0, niovs):
    ...
    print(runrange)
    reqname = 'PbPb2018_LM_SBNeg_z3_'+runranges
    print(reqname)
    dirbase='/store/user/ssanders/PbPb2018_LM_SBNeg_z3_'+runranges
    print(dirbase)
