...
config.JobType.psetName = '/home/sanders/PbPb_2018/VNAnalysis/vnanalysis_z3_cfg.py'
...
config.General.requestName = 'PbPb2018_KS_SBPos_z3_MB0'
config.Data.outLFNDirBase = '/store/user/ssanders/PbPb2018_KS_SBPos_z3_MB0'
...
config.JobType.pyCfgParams = ['noprint','part=KS','massRange=SBPos','rap=Mid','lumifile=Cert_326381-3275640_PromptReco_Collisions18_JSON.txt','offset=offset_PbPb2018_1_March2020_326886_general.root','dbfile=HeavyIonRPRcd_PbPb2018_March2020_offline.db']
...
for i in range(0, niovs):
    ...
    print(runrange)
    reqname = 'PbPb2018_KS_SBPos_z3_'+runranges
    print(reqname)
    dirbase='/store/user/ssanders/PbPb2018_KS_SBPos_z3_'+runranges
    print(dirbase)
    infiles=['MC_Full_BDT_D4.KS.weights.xml','Cert_326381-327560_HI_PromptReco_Collisions18_JSON.txt','HeavyIonRPRcd_PbPb2018_March2020_offline.db','offset_PbPb2018_March2020_'+runranges+'.root']
    print(infiles)
    parms=['noprint','part=KS','massRange=SBPos','rap=Mid','lumifile=Cert_326381-327560_HI_PromptReco_Collisions18_JSON.txt','offset=offset_PbPb2018_March2020_'+runranges+'.root','dbfile=HeavyIonRPRcd_PbPb2018_March2020_offline.db']
    print(parms)
