...
config.General.requestName = 'PbPb2018_KS_SBPos_z15_MB0'
config.Data.outLFNDirBase = '/store/user/ssanders/PbPb2018_KS_SBPos_z15_MB0'
...
for i in range(0, niovs):
    ...
    print(runrange)
    reqname = 'PbPb2018_KS_SBPos_z15_'+runranges
    print(reqname)
    dirbase='/store/user/ssanders/PbPb2018_KS_SBPos_z15_'+runranges
    print(dirbase)
