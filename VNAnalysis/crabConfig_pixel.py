...
config.JobType.inputFiles=['json_DCSONLY_HI.txt','HeavyIonRPRcd_PbPb2018_pixel_offline.db','offset_PbPb2018_1_326886_pixel.root']
config.JobType.pyCfgParams = ['noprint','lumifile=json_DCSONLY_HI.txt','offset=offset_PbPb2018_1_326886_pixel.root','dbfile=HeavyIonRPRcd_PbPb2018_pixel_offline.db']
...
for i in range(2, niovs):
    ...
    print(runrange)
    reqname = 'PbPb2018_vn_pixel_'+runranges
    print(reqname)
    dirbase='/store/user/ssanders/PbPb2018_vn_MB_pixel_'+runranges
    print(dirbase)
    infiles=['json_DCSONLY_HI.txt','HeavyIonRPRcd_PbPb2018_pixel_'+runranges+'.db','offset_PbPb2018_pixel_'+runranges+'.root']
    print(infiles)
    parms=['noprint','lumifile=json_DCSONLY_HI.txt','offset=offset_PbPb2018_pixel_'+runranges+'.root','dbfile=HeavyIonRPRcd_PbPb2018_pixel_'+runranges+'.db']
    print(parms)
