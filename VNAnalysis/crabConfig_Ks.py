...
config.General.requestName = 'PbPb2018_Ks_SBNeg_MB0'
config.Data.outLFNDirBase = '/store/user/ssanders/PbPb2018_ks_SBNeg_MB0'
...
config.JobType.pyCfgParams = ['noprint','part=KS','massRange=SBNeg','rap=Mid','lumifile=Cert_326381-3275640_PromptReco_Collisions18_JSON.txt','offset=offset_PbPb2018_1_March2020_326886_general.root','dbfile=HeavyIonRPRcd_PbPb2018_March2020_offline.db']
...
for i in range(5, 6):
    ...
    print(runrange)
    reqname = 'PbPb2018_Ks_SBNeg_'+runranges
    print(reqname)
    dirbase='/store/user/ssanders/PbPb2018_Ks_SBNeg_'+runranges
    print(dirbase)
    ...
    print(infiles)
    parms=['noprint','part=KS','massRange=SBNeg','rap=Mid','lumifile=Cert_326381-327560_HI_PromptReco_Collisions18_JSON.txt','offset=offset_PbPb2018_March2020_'+runranges+'.root','dbfile=HeavyIonRPRcd_PbPb2018_March2020_offline.db']
    print(parms)
